...
**Status:** DRAFT rev. 2 — revised per `growth/reviews/review-offer-spec-2026-07-05.md` (evaluator REVISE, all 6 requirements addressed); awaiting Checkpoint B (Lawrence sets final prices; facilitator numbers additionally gated on ~2026-07-10 Ghana intel)
