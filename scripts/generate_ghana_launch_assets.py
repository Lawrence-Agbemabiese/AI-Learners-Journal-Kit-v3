...
RELEASE_ZIP = ROOT / "dist" / "ai-learners-journal-kit-v3.3.0.zip"
...
def build_bundles(files: list[Path]) -> dict[str, str]:
    ...
    write_readme(
        ...
        [
            ...
            "now needs a billing card linked to your Google account. See README.md for details.",
            "",
    ...
    write_readme(
        ...
        [
            ...
            "Begin with 02-student-portfolio-pack.pdf. For the friendly app, unpack 04-ai-learners-journal-kit-v3.3.0.zip and double-click the clearly labeled START HERE launcher.",
    ...
    zip_files(
        ...
        [
            ...
            (RELEASE_ZIP, "04-ai-learners-journal-kit-v3.3.0.zip"),
