...
def build_bundles(files: list[Path]) -> dict[str, str]:
    ...
    write_readme(
        ...
        [
            ...
            "Mac: double-click \"Start AI Journal.command\".",
            "Windows: double-click \"Start AI Journal.bat\".",
            "",
            ...
            "     click \"Open Anyway\" next to \"Start AI Journal.command\". Enter your password if",
            "     asked, then click Open. After this, the double-click works normally.",
            "Windows (\"Windows protected your PC\"): click \"More info\", then \"Run anyway\".",
            "",
            "STILL STUCK ON MAC? RUN IT FROM THE TERMINAL (this always works):",
